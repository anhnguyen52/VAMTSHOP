...
const storage = new CloudinaryStorage({
  cloudinary,
  params: {
    folder: "product", // thư mục Cloudinary (có thể thay đổi)
...
const uploadMultiple = multer({ storage }).array("image_urls", 5); // tối đa 5 ảnh, field name là 'image_urls'

// Nếu muốn upload 1 ảnh:
const uploadSingle = multer({ storage }).single("image_urls");
